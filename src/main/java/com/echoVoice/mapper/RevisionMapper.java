...
import com.echoVoice.entity.utills.envers.CustomTrackingRevisionEntity;
...
@Mapper(componentModel = "spring", imports = {LocalDate.class, Instant.class, ZoneId.class, CustomTrackingRevisionEntity.class}, unmappedTargetPolicy = ReportingPolicy.ERROR)
public interface RevisionMapper {
    ...
    @Mapping(target = "userName", expression = "java(((CustomTrackingRevisionEntity) revision.getMetadata().getDelegate()).getUsername())")
